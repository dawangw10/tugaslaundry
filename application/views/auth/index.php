<nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <div class="container">
    <a style="font-size: 30px" class="page-scroll oleo-font navbar-brand" href="#home">Laundry Jenuh MAssesshhh</a>
...
<section class="pt-5">
  <div class="jumbotron jumbotron-fluid bg-info">
    <div class="container text-white text-center">
      <img style="box-shadow: 5px 5px 5px rgba(0,0,0,0.3)" src="<?= base_url(); ?>assets/img/img_properties/icon.jpg" alt="logo" class="img-fluid rounded mb-2" width="200">
      <h1 class="text-shadow display-4 oleo-font font-weight-bold">lAUNDRY JENUHHH</h1>
      ...
      <h5 class="text-shadow my-2">Namanya juga hidup pasti banyak <span class="font-weight-bold">Cobaan</span>, kalo banyak <span class="font-weight-bold">Cucian</span> bawa aja ke <span class="font-weight-bold oleo-font">Laundry JENUH</span></h5>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-lg-6 my-3">
		    	<h3 class="oleo-font">Laundry JENUH</h3>
		    	<div class="row">
		    		<div class="col-lg">
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-5"><a class="text-white" target="_blank" href="">+62 852 3649 4459/+62 856 0470 4887</a></div>
        </div>
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-8">Jl.KEPODANG,WRINGINAGUNG, KEC.JOMBANG, KAB.JOMBANG</div>
        </div>
      </div>
