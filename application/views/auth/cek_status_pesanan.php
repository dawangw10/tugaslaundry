<nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <div class="container">
    <a style="font-size: 30px" class="page-scroll oleo-font navbar-brand" href="<?= base_url('auth/'); ?>#home">Laundry JENUH</a>
...
<footer class="bg-dark text-white p-4 mt-n5">
	<div class="container-fluid">
		<div class="row justify-content-center">
	    	...
	    	<div class="row">
	    		<div class="col-lg">
					<span>&copy; Copyright <?= date('Y'); ?> All rights Reserved with Laundry JENUH.</span>
	    		</div>
	    	</div>
			</div>
			<div class="col-lg-6 my-3">
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-8">JL.menjangan,umbulsari dan JL.kepodang,jombang</div>
        </div>
      </div>
		</div>
