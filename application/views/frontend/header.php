...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">
    <img src="<?= base_url()?>assets/image/logo.jpg" height="40">
  </a>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 image-slider" src="<?= base_url()?>assets/image/slider/slide1.jpg" alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block w-100 image-slider" src="<?= base_url()?>assets/image/slider/slide2.jpg" alt="Second slide">
      <div class="carousel-caption d-none d-md-block bg-caption">
        <h5>Judul Slide 2</h5>
